  ...
  div(class = "col",
    div(
      ...
      div(class = "d-grid gap-1 col-12 mx-auto",
        tag("button", list(type = "button", `data-bs-target`=paste0("#collapse", gsub(".", "_", make.names(title), fixed = TRUE)), class = "btn btn-primary btn-lg", `data-bs-toggle`="collapse", 
          div(class = "display-5", span(class = paste0("ion ion-", icon)))
        ))
      ),
      div(
        class = "card-body",
        h3(title, class = "card-title"),
        div(class = "collapse", id = paste0("collapse", gsub(".", "_", make.names(title), fixed = TRUE)),
...
<div class="d-grid gap-1 col-12 mx-auto" style="padding-top:12px"><a href="https://github.com/bcgov/CCISS_ShinyApp" class="btn btn-primary btn-lg">Explorer sur GitHub <span class="ion ion-social-github"></span></a></div>
')
```
...
<div class="d-grid gap-1 col-12 mx-auto" style="padding-top:12px"><a href="https://github.com/rstudio/plumber" class="btn btn-primary btn-lg">Explorer sur GitHub <span class="ion ion-social-github"></span></a></div>
')
```
...
<div class="d-grid gap-1 col-12 mx-auto" style="padding-top:12px"><a href="https://github.com/meztez/bigrquerystorage" class="btn btn-primary btn-lg">Explorer sur GitHub <span class="ion ion-social-github"></span></a></div>
')
```

`bigrquerystorage` est un package R pour BigQuery Storage API. La motivation principale est de remplacer `bigrquery::bq_table_download`.

Le package est un mixte de C++ et R.
